export const en = {
  ...
  chat: {
    ...
    heroGreeting: "What's the plan for today?",
    thinking: "Reasoning",
    recent: "Recent",
  ...
  overview: {
    ...
    standaloneDesc:
      "Read-only disk view. Start /dashboard from inside carboncode code for live session state, MCP, and tools.",
    cockpit: "Cockpit",
    balance: "balance",
    tokens7d: "tokens · 7d",
    cacheHit: "cache hit",
    ...
    noSession: "No live session — /dashboard from inside carboncode code to attach.",
  ...
  usage: {
    ...
    noData: "No usage data yet — run a turn in carboncode chat / code / run and refresh.",
  ...
  sessions: {
    ...
    attachRequired:
      "Live session operations need an attached CLI session. Launch via carboncode chat or open the dashboard from inside a TUI session.",
    activeChip: "active",
    activePill: "active",
  },
  tools: {
  ...
  permissions: {
    ...
    standaloneWarning:
      "Mutations require /dashboard from inside an active carboncode code session — standalone carboncode dashboard can't tell which project's allowlist to edit.",
  },
  mcp: {
    loading: "loading MCP…",
    ...
    whyUnbridgedDesc:
      "This spec lives in your config.json but isn't bridged into the live session. MCP servers attach when carboncode code starts; the dashboard alone can't spawn the child process.",
    whyUnbridgedHint: "To activate: restart carboncode code, then refresh this dashboard.",
    bridgeFailed: "Bridge failed",
    bridgeFailedTitle: "bridge failed · in config",
    bridgeFailedHint:
      "Carbon Code tried to bridge this server and the attempt errored. Common causes: wrong URL, missing auth header, upstream 404/5xx, missing local command. Fix and restart carboncode code to retry.",
  ...
  memory: {
    ...
    pickDesc: "Project CARBON.md is committable; global notes live in ~/.carboncode/CARBON.md.",
    chars: "{count} chars",
    saved: "saved {scope}",
  ...
  hooks: {
    ...
    colScript: "script",
    noProject: "No active project — open /dashboard from carboncode code to edit project hooks.",
  ...
  skills: {
    ...
    builtinDesc:
      "Built-in skills ship with Carbon Code; the model picks them up automatically. To customize, create a project- or global-scoped skill with the same name.",
  ...
  system: {
    ...
    built: "● built",
    none: "— none",
    runIndex: "run carboncode index to build",
    usageLog: "usage log",
  ...
  semantic: {
    ...
    installOllamaDesc:
      "Carbon Code doesn't run package managers for you. Install Ollama first, then come back:",
    ...
    apiUrl: "API URL",
    apiKey: "API key",
    apiKeyStoredNote: "API key is stored in ~/.carboncode/config.json — do not share that file.",
    ...
    remoteProviderDesc:
      "Configure the full OpenAI-compatible embeddings URL here. Carbon Code will send requests exactly to the URL you provide.",
    ollama: "ollama",
    binary: "binary",
    found: "found",
    missing: "missing",
